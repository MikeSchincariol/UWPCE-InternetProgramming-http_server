...
class ResponseOkTestCase(unittest.TestCase):
    ...
    def test_passed_body_in_response(self):
        with pathlib.Path("webroot/sample.txt").open("rb") as fh:
            file_body = fh.read()
        bodies = [
            b"a body",
            b"a longer body\nwith two lines",
...
class ResolveURITestCase(unittest.TestCase):
    ...
    def call_function_under_test(self, uri, webroot):
    ...
    def test_directory_resource(self):
        ...
        actual_body, actual_mimetype = self.call_function_under_test(uri, "webroot")
        self.assertEqual(
            expected_mimetype,
            actual_mimetype,
    ...
    def test_missing_resource(self):
        uri = "/missing.html"
        self.assertRaises(NameError, self.call_function_under_test, uri, "webroot")
    ...
    def test_webroot_file_uris(self):
        ...
        for file_path in root.iterdir():
            ...
            with file_path.open("rb") as fh:
                expected_body = fh.read().decode('utf8')
